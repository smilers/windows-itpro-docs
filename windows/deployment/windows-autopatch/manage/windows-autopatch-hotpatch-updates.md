...
If you choose to no longer use Hotpatch updates you can clear the CHPE disasble flag (`HotPatchRestrictions=0`) then restart the device to turn on CHPE usage.  
